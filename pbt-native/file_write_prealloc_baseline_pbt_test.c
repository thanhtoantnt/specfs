 ...
 * Stronger considered:
 *   - State Machine: rejected — file_write has no explicit lifecycle state or state-branching API.
 *   - Differential: rejected — no second independently meaningful implementation of this contract.
...
int main(void)
{
    ...
    printf("pre_alloc baseline file_write property-based tests:\n");
    ...
    RUN_PROP("partial_out_of_range_is_noop", prop_partial_out_of_range_is_noop, 200);
