 ...
 *
 * Oracle: reference byte model over the pre-allocation variant's extent list.
 * The properties exercise exact allocated reads, sparse holes, out-of-range
 * pages, and zero-length no-op behavior against the real file_read symbol.
 */
#include <theft.h>
...
int main(void)
{
    ...
    access_count = 0U;
    printf("pre_alloc file_read property-based tests:\n");
