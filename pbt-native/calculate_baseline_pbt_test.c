// Oracle: algebraic/reference properties for calculate: result must be the longest
// common prefix of src/dst, NULL-terminated, and heap-owning deep copies; allocation
// failure must not crash.
#include <theft.h>
...
#include "../eval/extent/baseline/path_handling.c"
#undef realloc
...
{
    int failures = 0;
    printf("calculate baseline property-based tests:\n");
