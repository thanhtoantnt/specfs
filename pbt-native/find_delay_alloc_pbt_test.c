 ...
 * table and filename, lookup must inspect only hash_func(name), return the
 * first matching inode in that bucket, return NULL on misses/null inputs, and
...
int main(void)
{
    ...
    printf("find delay_alloc property-based tests:\n");
