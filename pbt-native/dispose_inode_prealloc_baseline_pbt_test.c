 ...
 *   - Differential: rejected, no independent pre_alloc inode destructor exists.
...
#include "../eval/pre_alloc/baseline/util.c"
...
{
    int failures = 0;
    printf("dispose_inode pre_alloc baseline property-based tests:\n");
