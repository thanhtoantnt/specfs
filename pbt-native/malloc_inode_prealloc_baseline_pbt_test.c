 ...
 *   - Differential: rejected, there is no independent pre_alloc baseline constructor to compare against.
...
{
    int failures = 0;
    printf("malloc_inode pre_alloc baseline property-based tests:\n");
